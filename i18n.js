(function () {
  ...
  const dict = {
    ...
    ja: {
      ...
      '首页': 'ホーム', '增长中枢': 'DXハブ', '全球案例': '導入事例', '战略优势': '戦略的優位性', '行业研报': '市場レポート', '关于愿景': 'ビジョン', '增长动态': 'ニュース', '增长情报': 'インテリジェンス', '申请合作': 'お問い合わせ', '战略核心': '戦略コア', '行业诊断': '経営診断', '增长支柱': '支援の柱', '盈利实验': '経営シミュレーション', '立即诊断': '診断を開始',
