(function () {
  ...
  const dict = {
    ...
    ko: {
      ...
      '技术底座': '테크 스택',
      '持续投入 AI 矩阵工厂与调度算法的研发，确保系统永远领先行业一个维度。': '지속적인 AI 연구를 통해 귀하의 매장이 항상 트렌드보다 한 발 앞서 나가게 합니다.',
      '长期主义': '장기적인 파트너십',
      '拒绝割韭菜式的加盟。我们通过 60 天盈利实验，只与真正具备成长基因的门店同行.': '단기적인 이익을 쫓는 가맹 방식은 거부합니다. 우리는 성장 DNA를 가진 매장과만 함께합니다.',
      '共생 생태계': '공생 생태계',
      '构建一个连接全球供应链与本地服务专家的柔性网络，实现价值链的利润重分配。': '글로벌 공급망과 지역 전문가를 연결하여 공정한 수익 분배를 실현하는 네트워크를 구축합니다.',
      ...
      '该店通过接入 WIGSWAN 智能调度中枢，成功将客单价从传统美业水平提升了 3.2 倍。核心在于利用 AI 矩阵工厂持续输出高粘性案例视频，精准捕获了周边 5 公里内的高净值脱发客群。': 'AI 허브 도입을 통해 객단가를 기존 대비 320% 향상시켰습니다. K-Trend 콘텐츠 팩토리를 통해 반경 5km 내 고소득 탈모 케어 고객을 정밀하게 타겟팅하여 유입시켰습니다.',
      ...
      '© 2026 WIGSWAN. 赋能手艺人，重构美业链.': '© 2026 WIGSWAN. 아티스트 지원 및 뷰티 체인 혁신.',
      ...
      '美业云链不是一个加盟品牌，而是一套连接全球供应链、本地화 서비스 전문가와 고가치 소비자를 연결하는 “신경계”. AI 배정을 통해 모든 미용실이 최고급 맞춤 가발 서비스 역량을 갖게 합니다.': 'WIGSWAN은 단순 가맹 브랜드가 아닌, 공급망과 전문가, 고객을 잇는 ‘인텔리전트 시스템’입니다. AI 배정을 통해 모든 미용실이 하이엔드 맞춤 솔루션을 제공할 수 있게 합니다.',
      'WIGSWAN AI 调度中枢': 'WIGSWAN AI 배정 센터',
      '连接 1000+ 服务节点与全球柔性供应链': '1000개 이상의 노드와 글로벌 유연 공급망 연결',
      '矩阵式合伙人体系': '파트너 에코시스템',
      ...
      '门店无需压货，无需重资产. 通过 WIGSWAN 数字化工具，实现 24 小时内的项目极속嫁접과 수익 검증.': '매장은 재고나 과도한 투자 부담 없이, 디지털 도구를 통해 24시간 내 고부가가치 서비스를 도입하고 수익을 검증하세요.',
      '数字化赋能路径': 'DX로 가는 4단계 로드맵',
  ...
  function applyChinaRestructuring() {
    ...
    if (roiSection && !document.querySelector('.live-dispatch-monitor')) {
      ...
      const cases = [
        ...
        '【深圳】罗湖老店：90天LTV激活老客，转化头피养护年卡，业绩提升 45%',
