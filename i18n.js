(function () {
  ...
  const dict = {
    en: {
      ...
      '国际采购合作': 'Global Sourcing',
      '面向品牌、批发商与专业工作室': 'For brands, wholesalers and professional studios',
      '立即下载《2026转型手册》': 'Download the 2026 Transformation Manual',
      '获取门店增长评估框架与行动清单': 'Get the salon growth audit framework and action checklist',
      ...
      'WIGSWAN 行业研报：不定期发布美业、假发、门店数字化与客户价值运营相关的行业分析、趋势观察和专题报告。': 'WIGSWAN market reports with localized analysis for salon growth, hair replacement services, digital operations, and customer value strategy.',
      '行业研报 | 趋势分析与专题报告 - WIGSWAN': 'Market Reports | Local Growth Analysis - WIGSWAN',
      '面向美业经营者的行业研报与增长分析': 'Market reports for beauty business owners',
      '这里将不定期发布 WIGSWAN 对美业、假发消费、门店数字化、内容获客与客户价值运营的观察。内容以趋势判断、经营框架和专题报告为主，帮助合作伙伴更早看见行业变化。': 'WIGSWAN publishes localized observations on beauty services, hair replacement demand, digital operations, content-led acquisition, and customer value strategy.',
    ...
    ja: {
      ...
      'WIGSWAN 行业研报：不定期发布美业、假发、门店数字化与客户价值运营相关的行业分析、趋势观察和专题报告。': 'WIGSWANの市場レポート：美容室、ウィッグサービス、DX運営、顧客価値運営に関する日本市場向け分析。',
      '行业研报 | 趋势分析与专题报告 - WIGSWAN': '市場レポート | ローカル成長分析 - WIGSWAN',
      '面向美业经营者的行业研报与增长分析': '美容事業者向け市場レポート',
      '这里将不定期发布 WIGSWAN 对美业、假发消费、门店数字化、内容获客与客户价值运营的观察。内容以趋势判断、经营框架和专题报告为主，帮助合作伙伴更早看见行业变化。': 'WIGSWANは、美容室、ウィッグ需要、デジタル運営、集客、顧客価値運営に関する市場分析を発信します。',
      ...
      '首页': 'ホーム', '增长中枢': 'DXハブ', '全球案例': '導入事例', '战略优势': '戦略的優位性', '行业研报': '市場レポート', '关于愿景': 'ビジョン', '增长动态': 'ニュース', '增长情报': 'インテリジェンス', '申请合作': 'お問い合わせ', '战略核心': '戦略コア', '行业诊断': '経営診断', '增长支柱': '支援の柱', '盈利实验': '経営シミュレーション', '国际采购': 'グローバル調達', '立即诊断': '診断を開始',
      ...
      '国际采购合作': 'グローバル調達のご相談',
      '面向品牌、批发商与专业工作室': 'ブランド、卸売業者、専門スタジオ向け',
      '立即下载《2026转型手册》': '「2026 変革マニュアル」をダウンロード',
      '获取门店增长评估框架与行动清单': 'サロン成長評価フレームと実行チェックリストを入手',
    ...
    ko: {
      ...
      '开启增长评估': '성장 진단 시작',
      '国际采购合作': '글로벌 소싱 상담',
      '面向品牌、批发商与专业工作室': '브랜드, 도매업체 및 전문 스튜디오 대상',
      '立即下载《2026转型手册》': '2026 전환 매뉴얼 다운로드',
      '获取门店增长评估框架与行动清单': '매장 성장 평가 프레임워크와 실행 체크리스트 받기',
      ...
      'WIGSWAN 行业研报：不定期发布美业、假发、门店数字化与客户价值运营相关的行业分析、趋势观察和专题报告。': 'WIGSWAN 시장 리포트: 미용실 성장, 가발 서비스, 디지털 운영, 고객 가치 전략에 대한 한국 시장 분석.',
      '行业研报 | 趋势分析与专题报告 - WIGSWAN': '시장 리포트 | 현지 성장 분석 - WIGSWAN',
      '面向美业经营者的行业研报与增长分析': '미용 사업자를 위한 시장 리포트',
      '这里将不定期发布 WIGSWAN 对美业、假发消费、门店数字化、内容获客与客户价值运营的观察。内容以趋势判断、经营框架和专题报告为主，帮助合作伙伴更早看见行业变化。': 'WIGSWAN은 미용 서비스, 가발 수요, 디지털 운영, 콘텐츠 기반 상담 전환, 고객 가치 운영에 대한 현지 시장 분석을 제공합니다.',
