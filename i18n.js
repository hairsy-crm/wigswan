(function () {
  ...
  const dict = {
    ...
    ja: {
      ...
      '开启增长评估': '成長ポテンシャル診断を開始', '获取《2026美业增长白皮书》': '「2026 美容業界DX白書」を請求する', '传统美业正在集体失效': '従来型サロン経営の課題', '为什么 90% 的门店守着优质流量，却陷入低客单、低复购的增长泥潭？': 'なぜ多くのサロンが、高い技術力を持ちながら収益性の向上に苦心しているのでしょうか？',
